...
function hasCycle(linkedList) {
  ...
  //you have a fast and a slow pointer
  //the fast pointer moves 2 nodes every time slow moves 1 
  //if this is a cycle, then the fast will catch up with the slow 
  //if not, fast will be null (or the next value will be null) and that's the end 
  let fast = linkedList.head
  let slow = linkedList.head 
  let pause = true //controls when slow can increment to the next node 
